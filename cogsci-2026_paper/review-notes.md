...
- [x] In addition, it remains unclear to me how the initial sample size was determined. If the intended sample was 50 participants per condition (as stated in the Experimental Design section), the rationale for recruiting 251 participants rather than 250 (50 x 5) should be clarified.
- [x] The number of participants is unclear. In the abstract and introduction, the study is described as including 219 participants, whereas the methods section refers to 251 participants. Why were approximately 30 participants excluded? The number excluded should be clearly stated.
- [x] If the final sample consisted of 219 participants, it is not possible to divide them into five groups of 50 participants per condition as stated. Please clarify how participants were allocated to conditions.
- [x] One issue is that target sample size was not clearly motivated, the number of participants is not consistently reported within the manuscript, and it is unclear why exactly approx. 30 participants were eventually excluded from analysis and how they were distributed across conditions
...
- [x] If there is existing evidence that participants make compensatory errors, relevant literature should be cited.
## Experiment Design
...
- [x] For a non-expert reader, the methods, particularly the construction of the matrices, were difficult to follow. Additional clarification could help improve readability.
- [x] While I understand that word limits constrain the level of methodological detail, the statistical approach, and particularly the algorithm used to generate the matrices, may be difficult to follow for readers who are not highly familiar with these methods. In particular, point 2 would benefit from clarification, as the concept of “7 timesteps” is not fully clear.
...
# Results
- [x] References to figures illustrating the effects of surprisal and previous entropy across learning are unclear, and the figures themselves lack captions.
- [x] Given my limited expertise in statistical modeling, parts of the Results section were difficult for me to fully understand. That said, the description of the main effects and interaction effects is generally clear, even for readers with limited modeling experience.
...
- [x] The explanation of how the maximum structure was found seems to repeat information already provided in the statistical analysis section and may therefore be unnecessary.

# Discussion:
- [x] In my opinion, in the Discussion, the claim that learners are “truly aware” should be reconsidered or rephrased. The term aware suggests explicit knowledge, whereas the learning mechanisms appear to involve implicit procedural learning.
- [ ] One limitation of the discussion is that it relies almost exclusively on a single citation (Ullman, 2004). Broadening the discussion by referencing additional work in the literature would strengthen the interpretation of the findings.
If space is needed for additional references and discussion, the section subtitles could potentially be removed.
