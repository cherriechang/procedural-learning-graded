...
# Abstract
::: {.abstract}
Procedural learning—the implicit acquisition of motor and cognitive skills—has been proposed to support diverse abilities from typing to language acquisition. However, traditional paradigms test only simple statistical structures: deterministic sequences or binary probability contrasts. We introduce a novel serial reaction time paradigm where participants respond to stimuli appearing in sequences generated from transition matrices with graded entropy levels across positions, creating a continuous gradient of transition probabilities. Across 203 participants and five conditions (4-8 positions), we found robust effects of both surprisal (transition probability) and entropy (positional uncertainty) on reaction times. These effects emerged within 20-40 minutes and persisted across all conditions, with no interaction between surprisal and entropy—indicating that learners tracked specific transition probabilities even at high-uncertainty positions. These findings demonstrate that procedural learning is sensitive to fine-grained distributional structure and scales beyond traditional 4-position paradigms, supporting theoretical proposals linking procedural learning mechanisms to skill acquisition in complex domains like language.

**Keywords:** procedural learning, implicit learning, statistical learning, surprisal, entropy
:::
